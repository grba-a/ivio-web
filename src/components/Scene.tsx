        ...
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <div className={`lg:col-span-5 ${flipped ? 'lg:order-2 lg:col-start-8' : ''}`}>
            <div data-reveal className="flex items-baseline gap-3">
              ...
              <span aria-hidden className="h-px flex-1 max-w-16" style={{ background: 'var(--line)' }} />
            ...
            <ul data-reveal data-reveal-delay="180" className="mt-8 space-y-2.5">
              {scene.facts.map((f) => (
                <li key={f} className="flex gap-3 font-mono text-[11px] leading-relaxed tracking-[0.06em]">
            ...
            <a
              ...
              className="mt-9 inline-flex min-h-11 items-center gap-2 border-b pb-1 text-[15px] transition-[gap] sm:hover:gap-3.5"
          ...
          <div className={`lg:col-span-6 ${flipped ? 'lg:order-1 lg:col-start-1' : 'lg:col-start-7'}`}>
            {m.kind === 'route' && (
              <div data-reveal className="rounded-sm border px-4 py-8 sm:px-8 sm:py-12" style={{ borderColor: 'var(--line)' }}>
